...
- OR, a random quote- OR, a randome favorite quote */
...
$query = 'SELECT if, quote, source, facorite FROM quotes ORDER BY RAND() DESC LIMIT 1';
} elseif (isset($_GET['favorite'])) {
$query = 'SELECT id, quote, source, favorite FROM quotes WHERE favorite=1 ORDER BY RAND() DESC LIMIT 1';

} else {

$query = 'SELECT id, quote, source, favorite FROM quotes ORDER BY date_entered DESK LIMIT 1';
}
// Run the query:
...
print '<p><a href"index.php">Latest</a> <-> <a href="index.php?rtandom=true">Random</a> <-> 
